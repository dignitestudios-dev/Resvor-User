        ...
        >
          <div className="p-4 bg-[#F5F5F5] rounded-xl">
            ...
            <div className="bg-[#FFFFFF] rounded-[24px] p-5">
              ...
              {/* Reservation Info */}
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-5 text-sm ">
                <div className="space-y-4">
                  <p className="font-semibold text-[#000000] text-[18px] ">
                    Event Type
                  </p>
                  <p className="text-[#000000] text-[16px] ">Birthday Party</p>
                </div>
                <div className="space-y-4">
                  <p className="font-semibold text-[#000000] text-[18px] ">
                    Check-in Date
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[#000000] text-[16px] ">10:00 PM</p>
                </div>
                <div className="space-y-4">
                  <p className="font-semibold text-[#000000] text-[18px] ">
                    Guest Count
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[#000000] text-[16px] ">$1000</p>
                </div>
              </div>
