          ...
          <div className="flex flex-col gap-6 w-full pt-4 px-12 pb-12 text-left text-[#212121] text-[14px] leading-[22px]">
            ...
            <div>
              ...
              <p className="text-[14px] text-[#181818B2]">
                By using the mobile application (&quot;App&quot;), you agree to
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-[14px] text-[#181818B2]">
                ...
                <li>
                  ...
                  overburden, or impair the App or interfere with other
                  users&lsquo; enjoyment.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-[14px] text-[#181818B2]">
                ...
                kind, including implied warranties of merchantability, fitness
