...
const Chat = () => {
  ...
  const currentChats = selectedUser ? chatState[selectedUser.id] || [] : [];

  const handleSendMessage = () => {
    if (
      (!messageInput.trim() && !fileInputRef.current?.files[0]) ||
      !selectedUser
    )
      return;
    ...
    <>
      ...
      <div className="flex px-5 lg:px-40">
        ...
        <div className="py-4 bg-white rounded-[16px] border border-gray-200 -mt-[16em]">
          {selectedUser && (
            <div className="bg-white border-b border-gray-200 p-4 flex items-center gap-3">
              <div
                ...
                className="cursor-pointer w-12 h-12 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center text-white font-semibold"
              >
                {selectedUser?.avatar}
              </div>
          ...
          <div className="flex-1 flex flex-col w-[800px] h-[660px]">
            {selectedUser ? (
              <>
